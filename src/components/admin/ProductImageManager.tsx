    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <button
          ...
          className="flex items-center justify-center space-x-3 px-8 py-4 bg-charcoal text-white rounded-2xl hover:bg-charcoal/90 transition-all shadow-xl"
        >
          <Upload size={18} />
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        {images.map((img, index) => {
          const optimized = optimizeUrl(img);
